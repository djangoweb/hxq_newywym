...
if (pdo_fieldexists('hxq_newywym_product','price')){
    pdo_query("ALTER TABLE ".tablename('hxq_newywym_product')." change price price int(10) not null default '0'");
}
...
if (!pdo_fieldexists('hxq_newywym_coupon','show')){
    pdo_query("ALTER TABLE ".tablename('hxq_newywym_coupon')." add show tinyint(1) not null default '0'");
}